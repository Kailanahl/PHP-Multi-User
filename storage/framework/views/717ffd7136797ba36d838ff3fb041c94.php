  ...
  <div class="bg-white container-sm col-6 border my-3 rounded px-5 py-3 pb-5">
    ...
    <div class="card mt-3">
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Menu Kepsek</li> 
        <?php endif; ?>
        ...
        <li class="list-group-item">Menu Siswa</li> 
        <?php endif; ?>
      </ul>
    </div>
...
</html><?php /**PATH F:\laravel-multi-user\resources\views/admin.blade.php ENDPATH**/ ?>